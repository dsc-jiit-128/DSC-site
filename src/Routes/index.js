...
import Bitbox1 from '../Components/bitbox/bitbox1';
      ...
      <HashRouter basename='/'>
        <div>
          ...
          <Switch>
            <Route
              path='/'
              render={() => <Home isDark={this.props.isDark} />}
              exact
            />
            <Route
              path='/highlights'
              render={() => <Timeline isDark={this.props.isDark} />}
              exact
            />
            <Route
              path='/Team'
              render={() => <Team isDark={this.props.isDark} />}
              exact
            />
            {/* <Route path="/hackheist" render={()=><Hackathon isDark={this.props.isDark}/>} component={Hackathon} exact /> */}
            <Route
              path='/bitbox'
              render={() => <Bitbox isDark={this.props.isDark} />}
              exact
            />
            <Route
              path='/bitbox1'
              render={() => <Bitbox1 isDark={this.props.isDark} />}
              exact
            />
            <Route
              path='/photobooth'
              render={() => <Photobooth isDark={this.props.isDark} />}
              exact
            />

            <Route
              path='/events'
              render={() => <EventPage isDark={this.props.isDark} />}
              exact
            />
            <Route
