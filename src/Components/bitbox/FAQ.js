  ...
  const faqArr = [
    {
      ...
      ans: 'A hackathon is social coding event where programmers, designers and developers collaborate to solve a problem and compete for cash prizes. Hackathons are a super-condensed learning experience and the time constraint helps you to break your shell to build something from the ground up with teamwork and harmony. BIT BOX aims to bring together the coding community under one roof to put their minds and skills towards a shared goal and to create new and innovative solutions',
    },
    {
      Q: 'Why would someone participate in a hackathon?',
      ans: 'People participate in hackathons for lots of reasons: the challenge, the creative outlet, the community collaboration, the networking, and swags. The plethora of problem statements act as a juggernaut for participants and keeps them on the edge of their seats.',
    },
    {
      Q: 'Who is this event for?',
      ans: 'Students with a passion to make something innovative with teamwork and who can solve problems in an efficient ingenious way.',
    },
    {
      Q: 'Is the event open to all ages?',
      ans: 'Yes, however you need to be enrolled in an undergraduate program.',
    },
    {
    ...
    {
      Q: 'Can we enhance old projects?',
      ans: 'No,100 percent of the coding part must be done in the hackathon period.',
    },
      ...
      <Container className='mt-3 mb-3' fixed>
        <Grid container spacing={3}>
          {faqArr.map((faq, idx) => {
            ...
            return (
              <Grid item xs={12} md={6} data-aos='zoom-in-down' key={idx}>
                <Accordion
