              ...
              <Box mt={2}>
                <Container>
                  <Typography component='p' variant='body1' align='left'>
                    ...
                    Developers program aimed for college students to help them
                    build their mobile, web, machine learning, cloud skills,
                    etc. We are basically a community with connections all over
